...
- Byte 10c does not audibly use `performedOffsetBeats`; synths still fire at the scheduled grid time. Byte 10d should be the first audible timing-shift byte.
