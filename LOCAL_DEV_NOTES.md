...
- Planning update after Byte 6c: player Ollama thinking should come before producer work. Next arc should add player profiles/backstory fragments, a deterministic thought-context selector, a strict player thought request/intent protocol, Ollama health/session primer, then one slow-thinking player loop.
