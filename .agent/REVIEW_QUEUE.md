...
- Byte 15b-b is ready for review: the candidate menu now has named deterministic strategies beyond micro-repairs, and manual model-critic outcomes record selected strategy plus score deltas versus local best and deterministic fallback. Review by ear whether the strategies feel meaningfully different, and confirm the model still cannot author notes.
