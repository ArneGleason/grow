...
- Byte 6a is implemented and ready for Claude review. Current review focus: verify mode state/control/readouts are clean, mode switching has no playback side effects yet, and Byte 6b has a natural hook for actual mode behavior.
