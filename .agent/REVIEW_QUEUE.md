...
- Byte 13b-b is approved and merged. Byte 13b-c1 should harden the writer before `musical.event_recorded`: read-only dump behavior, explicit unavailable/offline smoke coverage, bounded retry/backoff, pagehide best-effort flush, and a small persistence inspector/debug line.
