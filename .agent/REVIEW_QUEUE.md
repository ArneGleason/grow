...
- Current Claude Code/Mac Mini assignment: review Byte 3c for visible note-on flash, shared recent-activity/listening window, tonal-context-driven pattern notes, preserved default C mixolydian output, and unchanged transport lifecycle cleanup.
