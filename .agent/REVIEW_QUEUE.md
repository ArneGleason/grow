...
- Byte 11c-c is ready for review. Focus on whether the schema conditional is useful despite Ollama/llama.cpp's limited support, whether the explicit top-level/rationale warning is acceptable prompt weight, and whether the live probe is enough evidence before re-testing through the full slow loop.
