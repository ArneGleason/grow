...
- Byte 15a passed Claude's substrate review with one required feel fix, now applied: repair candidates are bounded to the phrase register and leap/surprise interval scoring is register-aware. Remaining review focus is listening sanity on Raw versus Repaired after the no-plummet fix, plus confirming the model critic remains deferred to Byte 15b.
