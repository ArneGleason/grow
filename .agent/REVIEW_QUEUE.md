...
- Byte 10d review focus: convert offsets beats-to-seconds, clamp audible fire time so pushes cannot land in the past or cross neighbors, keep `absoluteBeat`/listening/order grid-stable, and add replay assertions for offset determinism.
