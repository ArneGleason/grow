...
- Byte 10f-a review should confirm that `projected-json` is a thin model-facing adapter, not a second thought contract; music-card/split-card are still future calibrated alternatives.
