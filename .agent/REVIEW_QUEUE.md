...
- Next Byte 15 work should diversify the candidate menu beyond micro-repairs and log model-pick versus deterministic-best score deltas so the project can measure whether the model critic actually improves musical choice.
